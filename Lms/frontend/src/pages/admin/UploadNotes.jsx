...
import { Upload, FileText, AlertCircle, CheckCircle, FolderOpen, Info, Layers, BookOpen, Sparkles, Target, Award, Brain, Zap } from 'lucide-react'
...
export default function UploadNotes() {
  ...
  const submit = async (e) => {
    ...
    try {
      ...
      setMsg('Notes uploaded successfully! Your students can now access this material.')
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-3 mb-4 p-4 bg-gradient-to-r from-amber-50 to-orange-50 dark:from-amber-900/10 dark:to-orange-900/10 rounded-xl border border-amber-200 dark:border-amber-800">
                ...
                <div>
                  ...
                  <p className="text-sm text-amber-600/70 dark:text-amber-400/70">Select your study notes file</p>
                </div>
              </div>
                ...
                <div className="flex items-center justify-between p-4 bg-gradient-to-r from-emerald-50 to-green-50 dark:from-emerald-900/10 dark:to-green-900/10 rounded-xl border border-emerald-200 dark:border-emerald-800 shadow-sm">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-emerald-600/70 dark:text-emerald-400/70">{(file.size / 1024 / 1024).toFixed(2)} MB • Ready to upload</p>
                    </div>
                  </div>
                  <button
                    type="button"
              ...
              <div className="flex items-center gap-2 text-sm text-amber-600/70 dark:text-amber-400/70">
                ...
                <span>Upload high-quality materials for better student engagement</span>
              </div>
            </div>
